...
php-source-install:
  file.managed:
    ...
    - source: salt://models/php/files/php-5.6.9.tar.gz
    - user: root
    - group: root
    - mode: 755
    - require:
...
php-ini:
  file.managed:
    ...
    - source: salt://models/php/files/php.ini-production
    - user: root
    - group: root
    - mode: 644
...
php-fpm:
  file.managed:
    ...
    - source: salt://models/php/files/php-fpm.conf.default
    - user: root
    - group: root
    - mode: 644
...
php-fastcgi-service:
  file.managed:
    ...
    - source: salt://models/php/files/init.d.php-fpm
    - user: root
    - group: root
    - mode: 755
  cmd.run:
